...
还没开始，所以不需要考虑太多功能，目前最终目的只是像渐进式的展示《重构》中的示例，可以的话拓展为一个学习类的网站，再往后可以进行拓展编辑器，方便编辑，维护一个github库

要不转react，转的话可以学习并练习react，虽然codehike就是react，但是不影响，甚至可以作为一个模版、目标，去学习
